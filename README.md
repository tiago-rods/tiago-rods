...
## Sobre Mim
Estudante de Engenharia de Computação pela PUC Campinas,
Bolsista de Iniciação Científica pelo CNPEM no Laboratório Nacional de Biociencias (LNBio)
Atualmente trabalhando com projeto de Bioinformática de análise comparativa de ferramentas de perfilamento metabolômico de espectros de RMN ¹H

Computer Engineering student at PUC Campinas,
Undergraduate researcher at CNPEM in the national laboratory of biosciences (LNBio)
Currently working in a Bioinformatics project of comparative analysis of metabolomic profiling software in the NMR ¹H spectrum 
